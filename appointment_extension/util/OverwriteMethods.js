...
//jQuery.sap.registerResourcePath('cus/crm/mycalendar', '/sap/bc/ui5_ui5/sap/crm_mycal/');
jQuery.sap.require("cus.crm.mycalendar.util.Util");
jQuery.sap.declare("cus.crm.mycalendar.CRM_MYCALExtension.util.OverwriteMethods");
